# Script untuk menguji throttling pada endpoint yang membutuhkan resource tinggi
$url = "http://localhost:3000/laporan"
$totalRequests = 10
$results = @()

Write-Host "Memulai pengujian throttling pada endpoint yang membutuhkan resource tinggi..."
