# Script untuk menguji throttling pada endpoint pencarian
$url = "http://localhost:3000/lokasi-rental/search?keyword=jakarta"
$totalRequests = 10
$results = @()

Write-Host "Memulai pengujian throttling pada endpoint pencarian..."
